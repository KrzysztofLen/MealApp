...
import { mealsLabels, OrdersEnum } from "../../main";
    ...
    return (
      <div className={"ordersList__container"}>
        ...
        >
          <div className={"ordersList__values"}>
            ...
            <div className={"ordersList__icon"}>
              <span className="icon">
                <i
                  className={`fas ${
                    this.state.toggle ? "fa-angle-up" : "fa-angle-down"
                  }`}
                />
              </span>
            </div>
          ...
          <div className={"ordersList__status"}>
            {this.props.history !== true && (
              <button onClick={this.onDialogOpen}>Add Meal</button>
            )}
            <Modal
            ...
            <div className={"ordersList__statuses"}>
              ...
              <div className={"buttons has-addons"}>
                <span
                  className={`button ${
                    this.props.status === OrdersEnum.opened
                ...
                <span
                  className={`button ${
                    this.props.status === OrdersEnum.finalized
                      ? "is-primary is-selected"
                      : ""
                  }`}
                  onClick={this.onChangeOrderStatus.bind(
                    this,
                    OrdersEnum.finalized
                  )}
                >
                  {OrdersEnum.finalized}
                </span>
          ...
          <div className={"ordersList__meals"}>
            {this.props.meals.length > 0 && <Label labels={mealsLabels} />}
        ...
        <OrderDelete
          ...
          onConfirmDelete={this.onDeleteOrder}
          onClick={this.onDialogClose}
        />
      </div>
    );
